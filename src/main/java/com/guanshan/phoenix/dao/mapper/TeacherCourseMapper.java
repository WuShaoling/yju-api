...
public interface TeacherCourseMapper {
    ...
    /*-----customer start -----*/
    @Select("SELECT teacher_id FROM teacher_course WHERE course_id=#{courseId,jdbcType=INTEGER}")
    List<Integer> selectTeacherIdByCourseId(Integer courseId);

    @Select("SELECT courseId FROM teacher_course WHERE teacher_id=#{teacherId,jdbcType=INTEGER}")
    List<Integer> selectCourseIdByTeacherId(Integer teacherId);
}