...
public class ManagerController {
    ...
    @Transactional(rollbackFor = Throwable.class)
    public ResponseMessage<Integer> createCourse(@RequestBody ReqAddCourse reqAddCourse) throws ApplicationErrorException {
        int id = courseService.createCourse(reqAddCourse);
    ...
    public ResponseMessage<Integer> createModule(@RequestBody Module module) throws ApplicationErrorException {
